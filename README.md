...
| Description | Images | Languages & Technologies Used | Project Grade |
| :--- | :--- | :---: | :--- |
| **Days Coming Android App:** <br><br> :open_file_folder: [Days Coming App](https://github.com/eleanorbucke21/AndroidCA/tree/master) <br><br> Days Coming is a fictitious e-commerce Android application focusing on survivalism. This business-to-consumer online retailer offers products such as MRE's and gear for living off the grid. The project emphasizes user experience with detailed user stories and a robust feature list including authentication, product management, and a shopping cart. Technologies used include Kotlin, Java, Android SDK, and SQLite for local data management. | ![Am I Responsive](https://github.com/user-attachments/assets/0c9f03ce-885b-4c85-b619-b4bcd0841dac) | Kotlin, Java, Android SDK, SQLite | Pass |
| **CCT Rental Part 1:** <br><br> :desktop_computer: [CTT Rental 1](https://eleanorbucke21.github.io/webdevCA/) <br> :open_file_folder: [Github](https://github.com/eleanorbucke21/webdevCA)<br><br>CCT Rental Part 1 involves using JavaScript, HTML, and CSS to create web pages with added styling and interactive features. | ![Am I Responsive](https://github.com/user-attachments/assets/686afd1f-dd88-4408-a336-610120dc84fe) | JavaScript, HTML, CSS | Pass |
| **CCT Rental Part 2:** <br><br> :desktop_computer: [Live Website](https://cctrentalca2.onrender.com/) <br> :open_file_folder: [Github Repository](https://github.com/eleanorbucke21/CA2) <br><br>  CCT Rental Part 2 is a project focusing on creating websites, applications, and CRM systems using HTML, CSS, JavaScript, PHP, Bootstrap 4, and MySQL. It was locally tested using XAMPP. | ![Am I Responsive](https://github.com/user-attachments/assets/46d1ba72-31ce-4819-bdd9-20ff570cad54) | HTML, CSS, JavaScript, PHP, Bootstrap 4, XAMPP, MySQL | Pass |
...
| Description | Images | Languages & Technologies Used | Project Grade |
| :--- | :--- | :---: | :--- |
| <u>Portfolio Project 1:</u> <br><br> :open_file_folder: [Snappy Barber](https://github.com/eleanorbucke21/Snappy-Barber) <br> :desktop_computer: [Live Website](https://eleanorbucke21.github.io/Snappy-Barber/)  <br> <br> The fictional barber website. It is a page designed to showcase the barbers work and services. It is aimed at men who want a haircut or beard attended to. Users of the website will be able to find all the information they need to know about the barber. <br> <br> **Features:**<br> 1. CSS Flexbox and Grid <br> <br>  | ![Am I Responsive](https://github.com/eleanorbucke21/rubybm21/assets/107644138/25f7c0a3-098e-4f47-8a52-d9a86fc3fb8d) | HTML5, CSS | Pass  |
| <u>Portfolio Project 2:</u> <br><br> :desktop_computer: [Spock Rock](https://eleanorbucke21.github.io/spock-rock-paper-sissors/) <br> :open_file_folder: [Github Repository](https://github.com/eleanorbucke21/spock-rock-paper-sissors) <br><br> Spock Rock is a fictional game made famous by Sheldon Cooper in the tv show Big Bang Theory. This is a game against the computer where scores are kept <br><br> **Features:**<br> 1.  Popup with rules of the game. <br>2. Score Board <br><br> | ![Am I Responsive](https://github.com/eleanorbucke21/rubybm21/assets/107644138/a2312ed7-59fb-4bcb-a21f-e7b4808a37c5) | JavaScript, CSS  | Pass |
| <u>Portfolio Project 3:</u> <br><br> :desktop_computer: [Live Website](https://hangmaneleanorb.herokuapp.com/) <br> :open_file_folder: [Hangman](https://github.com/eleanorbucke21/HangMan) <br><br> A game of Hangman against the computer, there are 385 words to guess from. There is also visual representation of a hangman based on how many times a user inputs a letter not present. The user has six attempts before the game will ask if they want to replay. <br> <br> **Features:**<br> 1. Name Validation <br> 2. 5 Lives playing a game.<br> 3. Visual representation of hangman as you play. <br> | ![Am I Responsive](https://github.com/eleanorbucke21/rubybm21/assets/107644138/040b1d2e-9ec3-4cd5-bbf9-b047c23cfe30) | Python and Javascript | Pass |
| **Portfolio Project 4: Bawarchi Khana** <br><br> :open_file_folder: [Bawarchi Khana](https://github.com/eleanorbucke21/PP4) <br> :desktop_computer: [Live Site](https://pp4.herokuapp.com/)<br><br> Bawarchi Khana is a Pakistani recipe blog. Bawarchi khana means kitchen in Urdu. This website is deigned to showcase pakistani recipes that can be added by either admin or by a user who has registered to the website. Each user has the ability to like and dislike a recipe post. If the user is also the author of the recipe post they have the option to delete or edit the post. As admin for this blog, they have the option to approve or deny all posts and comments to be published on the website.<br><br> **Features:**<br> 1. User Authentication<br> 2. CRUD operations for standard users and admin. <br> 3. Admin approval <br> 4. Clopudinary API for storing and sharing images. <br> 5. Fully Responsive. | <img src="https://github.com/eleanorbucke21/rubybm21/assets/107644138/7573efdc-41f9-444c-b14d-27a737c2d419" width="250"> | HTML, JavaScript, Django, CSS | Pass |
